...
padding-top:0px;height:150px;">
  ...
  <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
    ...
    <div class="me-5 d-none d-lg-block">
      <span>Nos informations importante:</span>
    </div>
    <!-- Left -->
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="vues/v_politiqueprotectiondonnees.php" target="_blank" class="text-reset">Politique Protection des données</a>
          </p>
...
Useful links
          ...
          <p>
            <a href="#!" class="text-reset">lispum</a>
          </p>
        </div>
        <!-- Grid column -->
